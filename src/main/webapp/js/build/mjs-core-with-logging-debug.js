...
mjs.registerModule('mjs/logging/interfaces');
...
mjs.registerModule('mjs/util/Calendar');
...
mjs.registerModule('mjs/util/DateFormat');
...
mjs.registerModule('mjs/http/Url');
...
mjs.registerModule('mjs/logging/LogFactory');
...
(function($){ 
	...
	$this = { name: "{0}" }; 
	mjs = $;
	$.module("profiles/mjs-core-with-logging.js");
	/**
...
mjs.registerModule('profiles/mjs-core-with-logging.js');
