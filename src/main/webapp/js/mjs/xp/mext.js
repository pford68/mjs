...
(function ($) {
    ...
    Object.defineProperties(Object.prototype.mext, {
            ...
            value: function(){
                ...
                for (i in this){
                    if (this.hasOwnProperty(i)){
                        ...
                        else if ($.isFunction(p.mext.clone)){    // Create an Array.clone()?
                            clone[i] = p.mext.clone();
                        } */
                        else if (p.mext.type === "Object"){    // Create an Array.clone()?
                            clone[i] = $.clone(p);
                        }
                        else {
                            clone[i] = p;
