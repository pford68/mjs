describe("mjs/core/ObjectDecorator", function(){
    ...
    describe("map()", function(){
        var a = $.decorate(cdata).map(function(item){ return false; });
        var b = $.decorate(cdata).map(function(item){ return true; });
    ...
    describe("filter()", function(){
        var a = $.decorate(cdata).filter(function(item){ return false; });
        var b = $.decorate(cdata).filter(function(item){ return true; });
